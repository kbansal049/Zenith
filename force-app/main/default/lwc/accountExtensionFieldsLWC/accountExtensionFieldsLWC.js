...
import getSObjectDetailsNew from "@salesforce/apex/recordDetailLWCController.getSObjectDetailsNew";

export default class Record_Details_Multi_Column_LWC extends NavigationMixin(
  LightningElement
) {
  @api objectApiName;
  @api recordId;
  ...
  @wire(getSObjetFieldsFromFieldSet, {
    ...
    ObjectName: "Account_Extension__c"
  })
    ...
    if (resultWrapper.hasError) {
      ...
      getSObjectDetailsNew({
        ...
        .then((result) => {
          ...
          //console.log('Test recordDetail 1:'+recordDetail);
          this.accountExtId = recordDetail['Id'];
          //console.log('accountExtId :'+recordDetail['Id']);
          ...
          resultWrapper.fldList.forEach((ele) => {
            ...
            if (recordDetail.hasOwnProperty(ele.fieldAPIName)) {
              ...
              //console.log('--->>>'+ele.fieldAPIName+' ---->>>'+fieldValue);
            }
