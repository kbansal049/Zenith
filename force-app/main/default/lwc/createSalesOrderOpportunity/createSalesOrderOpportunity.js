...
import retriveCustomerDetails from '@salesforce/apex/CreateSalesOrderExtensionLWC.getCustomerDetails';
import createCaseForOverride from '@salesforce/apex/CreateSalesOrderExtensionLWC.doReview';

import { NavigationMixin } from "lightning/navigation";

export default class CreateSalesOrderOpportunity extends NavigationMixin(LightningElement) {
    ...
    handleCustomerDetails(event) {
        ...
        console.log('---handleCustomerDetails--this.oppRecord---', this.oppRecord);
        ...
        createCaseForOverride({ cow: this.salesOrderWrapper })
            .then(result => {
                ...
                if (result.isSuccess) {
                    ...
                    this.handleWrapperChange(result.cow);
    ...
    handleWrapperChange(wrap) {
        console.log('--handleWrapperChange--called--');
        const changeEvent = new CustomEvent('refreshwrap', { detail: wrap });
        this.dispatchEvent(changeEvent);
    }
    ...
    handleOpportunityCancel() {
        ...
        console.log('---this.oppRecord--', this.oppRecord.Id);
